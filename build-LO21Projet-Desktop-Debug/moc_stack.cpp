...
#include "../LO21ProjetCode/structures/stack.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Stack_t, stringdata) + ofs \
...
void Stack::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Stack::stateModification)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Stack::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Stack.data,
      qt_meta_data_Stack,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Stack.stringdata))
