...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QComputer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 90, 11)
    ...
    "g\0sliderMoved\0n\0insertBlank\0"
};
...
const QMetaObject QComputer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QComputer.data,
      qt_meta_data_QComputer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QComputer.stringdata))
