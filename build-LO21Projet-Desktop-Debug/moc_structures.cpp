/****************************************************************************
** Meta object code from reading C++ file 'structures.h'
**
...
#include "../LO21ProjetCode/structures.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'structures.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Pile_t, stringdata) + ofs \
...
void Pile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Pile::stateModification)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Pile::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Pile.data,
      qt_meta_data_Pile,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Pile.stringdata))
