...
/*! \brief   Classe servant pour les operateurs last(LASTARGS et LASTOP)
* A chaque opération réalisée, le controller s'assure que les (ou le) opérandes utilisé(s) pour cette opération, ainsi que l'opérateur, soient conservés.
